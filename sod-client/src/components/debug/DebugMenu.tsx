...
export default function DebugMenu({ setPlayer, setRoom }: Props) {
  ...
  return (
    <Box
      sx={{ position: "absolute", zIndex: 10, width: 300, background: "#fff" }}
    >
      <Box
        sx={{ gap: 1, display: "flex", flexDirection: "column", padding: 1 }}
      >
